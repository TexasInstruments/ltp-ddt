...
setup_firmware()
{
  ...
  case $MACHINE in
      *j721*|*j7200*|*am64xx*|*am62xx*|*am65*|*j784*|*am68*|*am69*|*am62sipxx*|*am62pxx*)
...
ins_pru_mods()
{
  ...
  case $MACHINE in
    am57*|am43xx*|am335x*|k2g*|am65*|am64*|am62xx*|*am62sipxx*|*am62pxx*)
      for __mod in ${__modules[@]}
      do
        modprobe ${__mod}
      done
...
toggle_rprocs()
{
  ...
  case $MACHINE in
      *j721*|*j7200*|*j784*|*am68*|*am69*|*am64xx*|*am62xx*|*am62sipxx*|*am62pxx*)
